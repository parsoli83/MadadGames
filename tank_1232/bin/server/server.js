...
var clientUpdater = function () {
    ...
    function queryAndSendData(clientData) {
         ...
         */
        sockets[clientData.id].emit('game_objects_update', Object.assign({}, perspective, quadtreeManager.queryGameObjects(queryArea), spatialHashManager.queryTracks(range), ammo, { scoreboard: scoreboardList }, { radar: radarObjects }));
    }
...
var updateScoreboard = function () {
    scoreboardList = Heap.nlargest(currentClientDatas.map(function (clientData) {
        ...
        return { screenName: tank.screenName, kills: tank.kills };
    });
};
